...
<section class="menu_sup">
        <div class="menu_title">
            <p class="main_menu">Criar Evento</p>
        </div>
        <div class="menu_btn">
    ...
    <section class="forms_body">
        ...
        <form id="form" class="forms">
            ...
            <div id="divnum" class="forms_div">
                ...
                <input id="f-img" class="input_form" type="text" name="Imagem" onchange="this.value = this.value.trim()">
            </div>
            <div id="divnum" class="forms_div">
            ...
            <div id="divnum" class="forms_div">
                <button type="button" onclick="GoPrincipal()" class="btn secundario"><p class="text_btn">Voltar</p></button> 
            </div>
        </form>
    </section>
    <div id="Modal">
    ...
    <script src="scripts/scriptcadastroevent.js"></script>
